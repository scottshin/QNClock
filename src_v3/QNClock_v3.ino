...
#if 1
{
  ...
  /**     */
    int a = 0, b = 0, c = 0;
    matrix_hour_to( hours, a, b );
    if ( a )
      leds.setPixelColor(a, cr_theme[a] );
    if ( b > 0 )
      leds.setPixelColor(b, cr_theme[b] );

    a = b = c = 0;
    matrix_min_to( minutes, a, b, c );
    if ( a )
      leds.setPixelColor(a, cr_theme[a] );
    if ( b )
      leds.setPixelColor(b, cr_theme[b] );
    if (c )
      leds.setPixelColor(c, cr_theme[c] );
